        ...
        <h1 className="text-2xl font-semibold pt-8 flex items-center gap-x-4">
         ...
         <section className="bg-white py-10 ">
          <div className="flex items-center justify-evenly md:flex-row flex-col">
            ...
            <button className=" px-4 py-2 rounded-full border-2 text-black border-black text-sm ">Calculator</button>
            
            <button className=" px-4 py-2 rounded-full border-2 text-black border-black text-sm ">Guides & FAQ</button>
          </div>
          </div>
         </section>
         <section className="bg-white py-10 ] flex justify-center ">
          <div className=" max-w-[1470px] p-10">
            <div className="flex gap-5 flex-col md:flex-row">
            <div className="flex flex-col  gap-y-3 bg-[#F0F7F1] p-10 rounded-lg">
              <h1 className="text-[#031610] text-lg leading-5 font-semibold">Buying your first Home with Better </h1>
              <svg width="48" height="49" viewBox="0 0 48 49" fill="none" class="transition ease-universal duration-300 fill-transparent hover:fill-[#004733] [&amp;_path]:fill-[#004733] group-hover:[&amp;_path]:fill-white [&amp;_rect]:stroke-[#A4A8A4] group-hover:[&amp;_rect]:stroke-none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.843384" width="47" height="47" rx="23.5" stroke="#A4A8A4"></rect><path d="M24 16.3434L22.59 17.7534L28.17 23.3434H16V25.3434H28.17L22.59 30.9334L24 32.3434L32 24.3434L24 16.3434Z" fill="#004733"></path></svg>
              <img alt="First Home" rel="preconnect" loading="lazy"  decoding="async" data-nimg="1" class=" rounded-lg object-cover w-72 "  src="https://media.better.com/better-com/homepage/learning-center/first-home.webp " />
            </div>

            <div className="flex flex-col md:flex-row gap-3 bg-[#F0F7F1] p-10 rounded-lg">
            <div className="flex flex-col   gap-y-3">
                <h1 className="text-[#031610] text-lg font-semibold">One Day Mortage</h1>
                <p className="text-[#525252] md:w-[700px] hidden md:block">Kick your home loan into hyperdrive. Going from locked rate to Commitment Letter takes weeks for traditional lenders. We do it in a single day. Traditional lenders deliver a Commitment Letter in a few weeks.</p>
                <svg width="48" height="49" viewBox="0 0 48 49" fill="none" class="transition ease-universal duration-300 fill-transparent hover:fill-[#004733] [&amp;_path]:fill-[#004733] group-hover:[&amp;_path]:fill-white [&amp;_rect]:stroke-[#A4A8A4] group-hover:[&amp;_rect]:stroke-none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.843384" width="47" height="47" rx="23.5" stroke="#A4A8A4"></rect><path d="M24 16.3434L22.59 17.7534L28.17 23.3434H16V25.3434H28.17L22.59 30.9334L24 32.3434L32 24.3434L24 16.3434Z" fill="#004733"></path></svg>
              
              </div>  
              <div>
              <img alt="One day mortgage" rel="preconnect" loading="lazy"  decoding="async" data-nimg="1" class=" rounded-lg object-cover md:w-96 w-full h-32" src="https://media.better.com/better-com/homepage/learning-center/one-day-mortgage.webp"/>
              </div>
            </div>
</div>
<div className="flex flex-col md:flex-row mt-5">
            <div className="flex flex-col-reverse md:flex-row  bg-[#F0F7F1] p-10 rounded-lg gap-2">
              <div>
              <img alt="Better HELOC" rel="preconnect" loading="lazy"  decoding="async" data-nimg="1" class="rounded-base object-cover md:w-48 w-full h-32 object-top rounded-lg mt-2 md:mt-0"  src="https://media.better.com/better-com/homepage/learning-center/better-heloc.webp" />
              </div>
              <div className=" flex flex-col gap-y-4 md:ml-5">
                <h1 className="text-[#031610] text-lg font-semibold">Better HELOC</h1>
                <p className="text-[#525252] w-[600px] hidden md:block">Introducing One Day HELOC™—your express lane to getting cash from your home with our Home Equity Line of Credit . Access up to 90% of your home equity as cash in as little as 7 days.</p>
                <svg width="48" height="49" viewBox="0 0 48 49" fill="none" class="transition ease-universal duration-300 fill-transparent hover:fill-[#004733] [&amp;_path]:fill-[#004733] group-hover:[&amp;_path]:fill-white [&amp;_rect]:stroke-[#A4A8A4] group-hover:[&amp;_rect]:stroke-none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.843384" width="47" height="47" rx="23.5" stroke="#A4A8A4"></rect><path d="M24 16.3434L22.59 17.7534L28.17 23.3434H16V25.3434H28.17L22.59 30.9334L24 32.3434L32 24.3434L24 16.3434Z" fill="#004733"></path></svg>
           
              </div>
            </div>

            <div className="md:ml-5 mt-5 md:mt-0 bg-[#F0F7F1] p-8 rounded-lg flex flex-col gap-y-3">
              <h1 className="text-[#031610] text-lg font-semibold">Insurance</h1>
              <svg width="48" height="49" viewBox="0 0 48 49" fill="none" class="transition ease-universal duration-300 fill-transparent hover:fill-[#004733] [&amp;_path]:fill-[#004733] group-hover:[&amp;_path]:fill-white [&amp;_rect]:stroke-[#A4A8A4] group-hover:[&amp;_rect]:stroke-none" xmlns="http://www.w3.org/2000/svg"><rect x="0.5" y="0.843384" width="47" height="47" rx="23.5" stroke="#A4A8A4"></rect><path d="M24 16.3434L22.59 17.7534L28.17 23.3434H16V25.3434H28.17L22.59 30.9334L24 32.3434L32 24.3434L24 16.3434Z" fill="#004733"></path></svg>
              <img alt="Insurance" rel="preconnect" loading="lazy"  decoding="async" data-nimg="1" class=" l rounded-base object-cover md:w-72 w-full h-32 mt-2 md:mt-0 rounded-lg"  src="https://media.better.com/better-com/homepage/learning-center/insurance.webp"/>
            </div> 
            </div>
          </div>
         </section>
