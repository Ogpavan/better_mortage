    ...
    <div className="pt-20 bg-[#004733] "> {/* Add padding to prevent content from overlapping */}
      ...
      <div className="flex items-center flex-col justify-center text-white">
        <h1 className="text-2xl font-semibold pt-8 flex items-center gap-x-4">
          ...
          Rate drop alert</h1>
          <div>
          <h1 className=" lg:px-32 font-bold leading-[1.2] md:leading-[1.1] m-0 p-0  w-auto tracking-tight md:tracking-tighter z-1 leading-small text-center text-textInverseSecondary md:relative top-24 md:top-[28px] pt-12 md:p-0 text-[50px] md:text-4xl lg:text-[90px]">The rate drop you&apos;ve been waiting for</h1>
          </div>
