...
export default function Page() {
  ...
  return (
    <>
      ...
      <section className="w-[70%] mx-auto py-40">
  ...
  Read Vishal&apos;s story
      ...
      <div className="relative mx-auto w-1/3 before:absolute before:left-1/2 before:block before:h-full before:w-1 before:translate-x-2/4 before:bg-gray-300">
